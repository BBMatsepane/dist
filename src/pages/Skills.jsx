      ...
      <section className="py-16 px-4 bg-rose-50">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            style={{ fontFamily: "satoshi-medium" }}
          >
            With experience in C++, C#, Python, and Java, I can design systems and build applications. I’m quick to learn, love troubleshooting, and focus on writing code that’s both functional and maintainable.
          </motion.p>
